...
func _build_checks() -> void:
	...
	function_displays_images.description = tr("The 'show_image' function should properly display the image")
	...
	button_calls_the_function.description = tr("The 'advance' function should trigger 'show_image' when the button is pressed")
